...
INSERT INTO categories(category_name, category_active)
...
VALUES('Samsung','Samsung, South Korean company that is one of the world’s largest producers of electronic devices. It produces about a fifth of South Korea’s total exports');
INSERT INTO brands(brand_name, brand_description)
VALUES('Motorola','Motorola is an American multinational telecommunications company. The company was divided into two independent companies, Motorola Mobility (sold to Google and acquired by Lenovo) and Motorola Solutions (the direct successor to Motorola)');
INSERT INTO brands(brand_name, brand_description)
VALUES('Xiaomi','Xiaomi is a Chinese electronics company founded in 2010 by Lei Jun. The company creates a wide range of products including hardware, software and Internet services');
INSERT INTO brands(brand_name, brand_description)
VALUES('Apple','Apple is an American multinational technology company headquartered in Cupertino, California, that designs, develops, and sells consumer electronics, computer software, and online services');
INSERT INTO brands(brand_name, brand_description)
VALUES('Huawei','Huawei is a Chinese information and communications technology company that specializes in telecommunications equipment. The company offers services and consumer electronics including wearables, modems, smartphones, tablets and PCs');
INSERT INTO brands(brand_name, brand_description)
VALUES('Nokia','Nokia is a Finnish multinational telecommunications, information technology, and consumer electronics company, founded in 1865. Nokia\'s headquarters are in Espoo, in the greater Helsinki metropolitan area');
INSERT INTO brands(brand_name, brand_description)
VALUES('Asus','Asus is a Taiwan-based multinational computer and phone hardware and electronics company headquartered in Beitou District, Taipei, Taiwan. Its products include desktops, laptops, netbooks, mobile phones, networking equipment, monitors, tablet PCs');
INSERT INTO brands(brand_name, brand_description)
VALUES('Sony','Sony is a Japanese multinational conglomerate corporation headquartered in Kōnan, Minato, Tokyo. The company owns the largest music entertainment business in the world, the largest video game console business');
INSERT INTO brands(brand_name, brand_description)
VALUES('Lenovo','Lenovo is a Chinese multinational technology company with headquarters in Beijing. The company manufactures, and sells personal computers, tablet computers, smartphones, workstations, servers, IT management software, and smart televisions');
INSERT INTO brands(brand_name, brand_description)
VALUES('Honor','Honor is a smartphone brand owned by Huawei Technologies. As part of the Huawei Consumer Business Group\'s dual-brand strategy, Honor provides smartphone handsets targeting young consumers but has released tablet computers and wearable technology as well');
INSERT INTO brands(brand_name, brand_description)
VALUES('Acer','Acer is a Taiwanese multinational hardware and electronics corporation, headquartered in Xizhi, New Taipei City, Taiwan. Acer\'s products include desktop PCs, laptop PCs tablets, servers, virtual reality devices, displays, smartphones and peripherals');
INSERT INTO brands(brand_name, brand_description)
VALUES('iHiFi ','Xue Lin Audio is a division of the small Chinese company XueLin Electronics Co., Ltd., founded in Shenzhen in 2002. The company specializes in the development of modern microcontrollers and smart logic chips');
INSERT INTO brands(brand_name, brand_description)
VALUES('Ritmix','Ritmix is ​​a well-known Korean brand of portable electronics. Starting in 2001 Ritmix has expanded its product range in less than 10 years to a full range of portable electronics: from headphones and voice recorders to GPS navigators and e-books');
...
INSERT INTO users(user_first_name, user_last_name, user_email, user_password, user_contact, user_enabled)
-- password: 123456789
VALUES('Ivan', 'Ivanov', 'ivan@gmail.com', '$2y$12$cAujXLjdBBiZptftPxyEc.jvHhFBycQTByXfH9yf8Magpfpc3QiOK', '+375 29 543 21 35', true);
INSERT INTO users(user_first_name, user_last_name, user_email, user_password, user_contact, user_enabled)
-- password: 987654321
VALUES('Petr', 'Petrov', 'petr@gmail.com', '$2y$12$KurpV/QUOir.9rJLKb7vaOe6jxUZu9l3f7oZFUfBXtC0MmgA6N.wy', '+375 29 345 12 53', true);
...
INSERT INTO addresses(user_address, address_line_one, address_line_two, city, state, country, postal_code, is_billing, is_shipping)
VALUES(2, 'Platonov street', '', 'Minsk', 'Minsk', 'Belarus', '220034', true, false);

-- populate products table, descriptions table, views table  
INSERT INTO products(product_name, product_code, product_brand, product_unit_price, product_quantity, product_active, product_category)
VALUES('HONOR 20 international version', 'MAIN1581865663258', 10, 400, 10, true, 1);
INSERT INTO descriptions(description_id, screen, color, processor, front_camera, rear_camera, capacity, battery, display_technology, graphics, wireless_communication)
...
INSERT INTO views(view_code, product_id)
...
INSERT INTO carts(cart_id, cart_total, cart_items)
VALUES(2, 0, 0);